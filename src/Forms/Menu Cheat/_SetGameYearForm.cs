...
{
    public partial class _SetGameYearForm : Civ2form
    {
        ...
        private void MainPanel_Paint(object sender, PaintEventArgs e)
        {
            ...
            StringFormat sf = new StringFormat();
            sf.LineAlignment = StringAlignment.Center;
            //e.Graphics.DrawString("# Turns Elapsed: " + Game.TurnNumber + ".", new Font("Times New Roman", 18), new SolidBrush(Color.FromArgb(191, 191, 191)), new Point(3 + 1, 17 + 1), sf);
            //e.Graphics.DrawString("# Turns Elapsed: " + Game.TurnNumber + ".", new Font("Times New Roman", 18), new SolidBrush(Color.FromArgb(51, 51, 51)), new Point(3, 17), sf);
