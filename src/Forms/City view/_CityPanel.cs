...
{
    public partial class _CityPanel : Civ2panel
    {
        ...
        //    InitializeComponent();
        //}
        public _CityPanel(Main parent, City city, int _width, int _height) : base(_width, _height, "", false)
        {
            ThisCity = city;
        ...
        private void BuyButton_Click(object sender, EventArgs e)
        {
            ...
            using (var CityBuyForm = new _CityBuyForm(ThisCity))
            {
        ...
        {
            //Use this so the form returns a chosen value (what it has chosen to produce)
            using (var CityChangeForm = new _CityChangeForm(ThisCity))
            {
        ...
        {
            _CityRenameForm CityRenameForm = new _CityRenameForm(ThisCity);
