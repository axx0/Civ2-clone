...
namespace civ2.Forms
{
    public partial class CityPanel : Civ2panel
    {
        ...
        Bitmap CityDrawing;
        DoubleBufferedPanel WallpaperPanel, ResourceMap, CityResources, UnitsFromCity, UnitsInCity, FoodStorage, ProductionPanel;
        Form CallingForm;
        ...
        public CityPanel(Main parent, City city, int _width, int _height) : base(_width, _height, "", 27, 11)   // TODO: correct padding for max/min zoom
        {
            ...
            this.Paint += new PaintEventHandler(CityPanel_Paint);
            ...
            //Faces panel
            DoubleBufferedPanel Faces = new DoubleBufferedPanel
            {
                Location = new Point(10, 10),
                Size = new Size(630, 50),    //stretched by 12.5 %
                BackColor = Color.Transparent
            };
            DrawPanel.Controls.Add(Faces);
        ...
        {
            e.Graphics.DrawImage(Draw.Citizens(_thisCity, 0), 0, 0);
        }
