...
{
    public partial class _CityReportOptionsForm : Civ2form
    {
        ...
        public _CityReportOptionsForm()
        {
            ...
            choiceOptions = new bool[11] { Game.Options.WarnWhenCityGrowthHalted, Game.Options.ShowCityImprovementsBuilt, Game.Options.ShowNonCombatUnitsBuilt, 
        ...
        private void OKButton_Click(object sender, EventArgs e)
        {
            ...
            Game.Options.WarnChangProductWillCostShields = choiceOptions[9];
