...
{
    public partial class _GraphicOptionsForm : Civ2form
    {
        ...
        public _GraphicOptionsForm()
        {
            ...
            choiceOptions = new bool[6] { Game.Options.ThroneRoomGraphics, Game.Options.DiplomacyScreenGraphics, Game.Options.AnimatedHeralds, 
