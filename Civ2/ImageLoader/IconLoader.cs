...
{
     public static void LoadIcons(Ruleset ruleset, Civ2Interface activeInterface)
        {
            var iconsImage = Images.LoadImage("ICONS", ruleset.Paths, "gif", "bmp");
            ...
            activeInterface.MapImages.ViewPiece = Raylib.ImageFromImage(iconsImage,new Rectangle(199, 256, 64, 32));

            activeInterface.MapImages.GridLines = Raylib.ImageFromImage(iconsImage,new Rectangle(183, 430, 64, 32));

            activeInterface.MapImages.GridLinesVisible = Raylib.ImageFromImage(iconsImage,new Rectangle(248, 430, 64, 32));
            ...
            activeInterface.UnitImages.BattleAnim = battleAnim;
        }
}