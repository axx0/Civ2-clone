...
public class EditTechnologies(GameScreen gameScreen) : AlwaysOnCommand(gameScreen, CommandIds.CheatEditTechnologies, [new Shortcut(Key.F6, ctrl: true, shift: true)])
{
