...
public class ScenarioParameters(GameScreen gameScreen) : AlwaysOnCommand(gameScreen, CommandIds.CheatSetScenarioParameters, [new Shortcut(Key.P, ctrl: true, shift: true)])
{
