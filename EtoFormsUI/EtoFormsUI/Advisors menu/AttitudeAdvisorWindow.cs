...
namespace EtoFormsUI
{
    public class AttitudeAdvisorWindow : Civ2form
    {
        ...
        public AttitudeAdvisorWindow(Main main) : base(main.ActiveInterface.Look,622, 421, 11, 11)
        {
        ...
        private void Surface_Paint(object sender, PaintEventArgs e)
        {
            ...
            Draw.Text(e.Graphics, $"{Game.GetActiveCiv.LeaderTitle} {Game.GetActiveCiv.LeaderName}: {Game.Date.GameYearString}", font1, Color.FromArgb(223, 223, 223),
