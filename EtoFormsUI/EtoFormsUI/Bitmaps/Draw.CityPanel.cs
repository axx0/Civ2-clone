...
namespace EtoFormsUI
{
    public static partial class Draw
    {
        ...
        {
            var panel = new Bitmap(195, 163, PixelFormat.Format32bppRgba);
            using (var g = new Graphics(panel))
            {
                // Icons
        ...
        public static Bitmap CityResources(City city)//, int foodIcons, int surplusIcons, int tradeIcons, int corruptionIcons, int taxIcons, int luxIcons, int sciIcons, int supportIcons, int productionIcons)
        {
            int x_size = 226;
            int y_size = 151;
            var icons = new Bitmap(x_size, y_size, PixelFormat.Format32bppRgba);
            using (var g = new Graphics(icons))
            {
        ...
        {
            var faces = new Bitmap(630, 50, PixelFormat.Format32bppRgba);
            using (var graphics = new Graphics(faces))
            {
                int spacing;
                switch (city.Size)
                {
        ...
        {
            var panel = new Bitmap(195, 191, PixelFormat.Format32bppRgba);    // Same size as production panel in city panel
            using (var g = new Graphics(panel))
            {
